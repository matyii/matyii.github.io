...
<div class="flex flex-wrap gap-4 justify-center items-center min-h-screen">
  ...
  <Card.Root class="w-full max-w-sm shadow-md">
    <Card.Header class="flex flex-col items-center justify-center space-y-2 text-center">
      ...
      <Card.Description>i'm lajos</Card.Description>
    </Card.Header>
    ...
    <Card.Root class="w-full max-w-sm relative shadow-md">
      ...
      <Card.Content class="flex flex-col gap-4">
        ...
        <div class="flex items-center gap-4">
          <img src={nowPlaying.item.album.images[0].url} alt="Album Art" class="w-24 h-24 rounded shadow-md hover:scale-105 transition-all" />
          <div>
            ...
            {#if activeDevice}
              <p class="text-muted-foreground text-xs mt-1 flex items-center gap-2">
